...
<main class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <!-- post form -->
      <form method="post" action="php/create-post.php" enctype="multipart/form-data">
          ...
          if ($result->num_rows > 0) {
            while($post = $result->fetch_assoc()) {
              ?>
                <div class="panel panel-default">
                  <div class="panel-body">
                    <?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $post['photo'] ).'"/>' ?>
                  ...
                  <div class="panel-footer">
                    ...
                    <span>
                      posted <?php echo $post['created_at']; ?> by <a href="profile.php?username=<?php echo $post_author; ?>"><?php echo $post_author; ?></a>
                      <a class="text-danger" href="php/like-post.php?id=<?php echo $post['id']; ?>">[like]</a>
                      <a class="text-danger" href="php/unlike-post.php?id=<?php echo $post['id']; ?>">[dislike] </a>
                      <span class="pull-right"><?php echo $post['likes'] ?></span>
                    </span>
                  </div>
                </div>
              <?php
